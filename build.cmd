...
%FAKE% %NYX% "target=%TARGET%" appName=Elders.Cronus.Projections.Cassandra appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Cronus.Projections.Cassandra
